...
public class M2DCommandImpl {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext buildContext) {
        dispatcher
                .register(Commands.literal("mc2discord")
                                ...
                                .then(Commands.literal("add")
                                        .then(Commands.argument("targets", GameProfileArgument.gameProfile())
                                                .suggests((context, suggestionsBuilder) -> {
                                                    ...
                                                    if (result.isEmpty()) throw PLAYER_ALREADY_HIDDEN.create();
                                ...
                                .then(Commands.literal("remove")
                                        .then(Commands.argument("targets", GameProfileArgument.gameProfile())
                                                ...
                                                .executes((context) -> {
                                                    ...
                                                    if (result.isEmpty()) throw PLAYER_NOT_HIDDEN.create();
                                        ...
                                        .then(Commands.argument("targets", GameProfileArgument.gameProfile())
                                                ...
                                                .then(Commands.argument("discord_id", LongArgumentType.longArg(0))
                                                        .executes((context) -> {
                                                            ...
                                                            if (result == null) throw PLAYER_ALREADY_LINKED.create();
                                ...
                                .then(Commands.literal("remove")
                                        .then(Commands.argument("targets", GameProfileArgument.gameProfile())
                                                .suggests((context, suggestionsBuilder) -> {
                                                    ...
                                                    if (result.isEmpty()) throw PLAYER_NOT_LINKED.create();
